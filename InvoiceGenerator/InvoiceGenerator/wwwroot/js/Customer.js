...
//    try {
//        const r = await fetch(`/Customer/GetById?customerId=${id}`);
...
async function saveMode() {
    ...
    if (!name) {
        ...
        document.getElementById('err-customer').textContent = "Required";
        return;
    }

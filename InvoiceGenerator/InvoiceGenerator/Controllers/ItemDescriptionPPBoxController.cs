...
{
    //[RequireAdmin]
    public class ItemDescriptionPPBoxController : Controller
    {

        private readonly ItemDescriptionPPBoxService _svc;
        private readonly ItemSizeService _sizeSvc;

        public ItemDescriptionPPBoxController(
            ItemDescriptionPPBoxService svc,
        ...
        // GET: /ItemDescription
        public IActionResult PPBoxView() => View();
        ...
        [HttpGet]
        public IActionResult GetItemSizes(int departmentId)
        {
            var data = _sizeSvc.GetAll()
                .Where(s => s.DepartmentId == departmentId)
                .Select(s => new { s.SizeId, s.ItemSize_Code });
        ...
        public IActionResult GetDropdowns()
        {
            ...
            var packing = _svc.GetPackingTypes();
